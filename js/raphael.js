...
window.Raphael.vml && function (R) {
    ...
    elproto.transform = function (tstr) {
        ...
        // matrix.translate(-.5, -.5); //see issue https://github.com/DmitryBaranovskiy/raphael/issues/653
    ...
    R._engine.group = function (vml) {
        var el = document.createElement('div');// createNode("group"); vml group will disappear sometimes, its a bug
